...
exports.AttractionModule = AttractionModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([attraction_entity_1.Attraction])],
        controllers: [attraction_controller_1.AttractionController],
        providers: [attraction_service_1.AttractionService],
    })
], AttractionModule);
